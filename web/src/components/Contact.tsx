const links = [
    {
        href: "https://github.com/eskres/boxboxbox",
        label: "GitHub",
        icon: (
            <svg viewBox="0 0 128 128" width="32" height="32" fill="currentColor" aria-hidden="true">
    ...
    },
    {
        ...
        label: "Email",
        icon: (
            <svg fill="currentColor" viewBox="0 0 24 24" width="32" height="32" aria-hidden="true">
        ...
        <section className="flex flex-col gap-4 w-full text-center">
            ...
            <div className="flex justify-center gap-6 mt-4">
                {links.map(({ href, label, icon }) => (
                    <a key={label} href={href} aria-label={label} className="text-inherit hover:opacity-70 transition-opacity">
                        {icon}
                    </a>
                ))}
            </div>
